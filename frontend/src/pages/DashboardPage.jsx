import { Pulse, ArrowsClockwise, BatteryCharging, CaretDown, CaretLeft, CaretRight, GlobeHemisphereWest, MapTrifold, PaperPlaneTilt, Radio, SlidersHorizontal, SquaresFour, Waveform as WaveformIcon } from '@phosphor-icons/react';
...
function DashboardLoadingSkeleton() {
  ...
  return <div className="dashboard-boot min-h-screen" aria-busy="true" aria-label="Preparing Foresight dashboard">
    <aside className="dashboard-boot-sidebar"><div className="dashboard-boot-sidebar-header overflow-hidden bg-white"><img src="/logo.png" alt="Foresight" className="dashboard-boot-logo" /><button type="button" aria-label="Collapse information panel" className="dashboard-boot-icon-button"><CaretLeft weight="duotone" size={16} /></button></div><div className="dashboard-boot-sidebar-content"><div className="dashboard-boot-health"><div className="flex items-center justify-between"><SkeletonBlock className="h-2 w-24" /><Radio weight="duotone" size={16} className="text-moss-500" /></div><SkeletonBlock className="mt-3 h-11 w-32" /><SkeletonBlock className="mt-3 h-2 w-28" /></div><div className="mt-3 grid grid-cols-2 gap-2"><SkeletonBlock className="h-16 w-full" /><SkeletonBlock className="h-16 w-full" /></div><div className="mt-6 flex items-center justify-between"><SkeletonBlock className="h-2 w-16" /><SkeletonBlock className="h-2 w-12" /></div><div className="mt-3 space-y-2">{placeholderBeacons.map((beacon) => <div key={beacon} className="dashboard-boot-beacon"><span className="h-2 w-2 rounded-full bg-moss-300" /><div className="min-w-0 flex-1"><SkeletonBlock className="h-2 w-20" /><SkeletonBlock className="mt-2 h-2 w-14" /></div><BatteryCharging weight="duotone" size={13} className="text-slate-400" /></div>)}</div></div></aside>
    <main className="dashboard-boot-main"><header className="dashboard-boot-topbar"><nav className="flex items-center gap-1"><span className="dashboard-boot-nav-link"><SquaresFour weight="duotone" size={14} /> Monitor</span><span className="dashboard-boot-nav-link"><SlidersHorizontal weight="duotone" size={14} /> Scenarios</span></nav></header><div className="dashboard-boot-content"><div className="flex items-end justify-between gap-4"><div><SkeletonBlock className="mb-3 h-2 w-20" /><SkeletonBlock className="h-8 w-48" /><SkeletonBlock className="mt-2 h-2 w-64" /></div><SkeletonBlock className="h-14 w-28" /></div><section className="dashboard-boot-card mt-5"><div className="flex items-center justify-between"><SkeletonBlock className="h-4 w-32" /><div className="flex gap-2"><span className="dashboard-boot-map-control"><MapTrifold weight="duotone" size={14} /></span><span className="dashboard-boot-map-control"><GlobeHemisphereWest weight="duotone" size={14} /></span></div></div><div className="dashboard-boot-map mt-4"><div className="dashboard-boot-map-grid" /><span className="dashboard-boot-map-node node-one" /><span className="dashboard-boot-map-node node-two" /><span className="dashboard-boot-map-node node-three" /></div><SkeletonBlock className="mt-3 h-2 w-52" /></section><div className="mt-4 grid gap-4 xl:grid-cols-[minmax(0,1.25fr)_minmax(0,1.55fr)]"><section className="dashboard-boot-card h-[290px]"><div className="flex items-center justify-between"><SkeletonBlock className="h-4 w-28" /><div className="flex gap-2"><SkeletonBlock className="h-7 w-20" /><SkeletonBlock className="h-7 w-20" /></div></div><div className="mt-6 space-y-5">{[1, 2, 3, 4].map((item) => <div key={item} className="flex items-center gap-3 border-t border-slate-200 pt-3"><span className="h-2.5 w-2.5 rounded-full bg-moss-300" /><SkeletonBlock className="h-3 flex-1" /><SkeletonBlock className="h-3 w-12" /></div>)}</div></section><section className="dashboard-boot-card h-[290px]"><div className="flex items-center gap-2"><Pulse weight="duotone" size={16} className="text-moss-500" /><SkeletonBlock className="h-4 w-28" /></div><div className="dashboard-boot-chart mt-7"><span /><span /><span /><span /><span /><span /><span /><span /></div></section></div><section className="dashboard-boot-card mt-4 h-44"><div className="flex items-center gap-2"><SkeletonBlock className="h-4 w-32" /><SkeletonBlock className="h-2 w-14" /></div><div className="mt-7 grid grid-cols-3 gap-5"><SkeletonBlock className="h-3 w-full" /><SkeletonBlock className="h-3 w-full" /><SkeletonBlock className="h-3 w-full" /></div></section></div></main><aside className="dashboard-boot-assistant"><button type="button" aria-label="Collapse assistant panel" className="dashboard-boot-icon-button"><CaretRight weight="duotone" size={16} /></button><div className="flex items-start gap-3 pt-5"><span className="dashboard-boot-assistant-icon"><WaveformIcon weight="duotone" size={18} /></span><div><SkeletonBlock className="h-2 w-24" /><SkeletonBlock className="mt-3 h-4 w-32" /><SkeletonBlock className="mt-2 h-2 w-44" /></div></div><div className="dashboard-boot-card mt-6 h-20"><SkeletonBlock className="h-3 w-32" /><SkeletonBlock className="mt-3 h-2 w-44" /></div><div className="mt-auto flex gap-2 pt-5"><SkeletonBlock className="h-10 flex-1" /><span className="dashboard-boot-send"><PaperPlaneTilt weight="duotone" size={15} /></span></div></aside>
  </div>;
